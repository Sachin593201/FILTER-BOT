...
API_ID = int(environ.get('API_ID', '25052125'))
API_HASH = environ.get('API_HASH', '99a3afa53ae1d99acc830372431a0057')
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6142658586').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-4639812826'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001776937683').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-4789841125') # give your force subscribe channel id here else leave it blank
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-4635492387')
...
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-4792013644').split()]  # For Multiple Id Use One Space Between Each.


# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://mangoww694:BIbSllydtSAxaujv@cluster0.iuwzrvz.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/sksmalayalamlatestmovie')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+46kep7K5LwY4YWQ1')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+xgwyrx8R2YZlNjI1') # Support Chat Link Without https:// or @
